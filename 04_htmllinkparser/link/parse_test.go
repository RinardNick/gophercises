...
func Test_text(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := text(tt.args.n); got != tt.want {
...
func Test_buildLink(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := buildLink(tt.args.n); !reflect.DeepEqual(got, tt.want) {
...
func Test_linkNodes(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := linkNodes(tt.args.n); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("linkNodes() = %v, want %v", got, tt.want)
			}
		})
	}
}
